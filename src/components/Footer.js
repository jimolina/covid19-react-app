            ...
            <footer className="bg-dark text-white">
                <div className="container-fluid py-2 px-5">
                    <div className="row">
                        ...
                        <div className="col-12 text-center">
                            <a href="https://github.com/jimolina/covid19-react-app" className="text-white" target="_Blank" rel="noopener noreferrer">
                                <i className="fab fa-github fa-2x" aria-hidden="true"></i>
                            </a>
                            <p className="card-text">Get the code in <a href="https://github.com/jimolina/covid19-react-app" className="text-white" target="_Blank" rel="noopener noreferrer">GitHub</a></p>
                        </div>
                    </div>
                    <hr />
                    <div className="row">
                        ...
                        <div className="col-12 col-md-9 title text-center text-md-right">
                            COVID-19 Info: React Example Code | <a href="http://josemolinaresume.com" target="_Blank" className="text-white" rel="noopener noreferrer"><u>josemolinaresume.com</u></a>
                        </div>
                    </div>
                </div>
            </footer>
